...
class BonusTestCase(ActorLogicTestCase):
    def test_add_bonus(self):
        ...
        self.assertEquals('0.00', balance_info['available_real_amount'])
        self.assertEquals('11.12', balance_info['available_virtual_amount'])
        ...
        self.assertEquals(subj_user_id, balance_info['user_id'])
        self.assertEquals('0.00', balance_info['available_real_amount'])
        self.assertEquals('20.02', balance_info['available_virtual_amount'])
        self.assertEquals('0.00', balance_info['locked_amount'])
